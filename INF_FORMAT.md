...
Inf diagrams are stored as JSON files with a well-defined structure. The format supports:
...
- Rich, nested structures for complex documentation
...
|-------|------|----------|-------------|
| `version` | string | Yes | Format version (current: "2.5") |
